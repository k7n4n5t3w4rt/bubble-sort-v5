// Verify that selecting Bitonic Sort initializes and renders the 3D canvas.
describe("Bitonic Sort selection", () => {
  it("initializes renderer and renders after selecting Bitonic", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Bitonic Sort by label.
    cy.get("#algorithm").select("Bitonic Sort");
