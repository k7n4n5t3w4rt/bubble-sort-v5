// Verify that selecting Cocktail Shaker Sort initializes and renders the 3D canvas.
describe("Cocktail Shaker Sort selection", () => {
  it("initializes renderer and renders after selecting Cocktail", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Cocktail Shaker Sort (either by value or label).
    cy.get("#algorithm").select("Cocktail Shaker Sort");
