// Verify that selecting Comb Sort initializes and renders the 3D canvas.
describe("Comb Sort selection", () => {
  it("initializes renderer and renders after selecting Comb", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Comb Sort (either by value or label).
    cy.get("#algorithm").select("Comb Sort");
