// Verify that selecting Shell Sort initializes and renders the 3D canvas.
describe("Shell Sort selection", () => {
  it("initializes renderer and renders after selecting Shell", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Shell Sort (either by value or label).
    cy.get("#algorithm").select("Shell Sort");
