// Verify that selecting Odd-Even Sort initializes and renders the 3D canvas.
describe("Odd-Even (Brick) Sort selection", () => {
  it("initializes renderer and renders after selecting Odd-Even", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Odd-Even Sort.
    cy.get("#algorithm").select("Odd-Even Sort");
