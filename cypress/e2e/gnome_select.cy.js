// Verify that selecting Gnome Sort initializes and renders the 3D canvas.
describe("Gnome Sort selection", () => {
  it("initializes renderer and renders after selecting Gnome", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Gnome Sort (either by value or label).
    cy.get("#algorithm").select("Gnome Sort");
