// Verify that selecting Insertion Sort initializes and renders the 3D canvas.
describe("Insertion Sort selection", () => {
  it("initializes renderer and renders after selecting Insertion", () => {
    cy.visit("/", {
      onBeforeLoad(win) {
    ...
    // Switch to Insertion Sort (either by value or label).
    cy.get("#algorithm").select("Insertion Sort");
