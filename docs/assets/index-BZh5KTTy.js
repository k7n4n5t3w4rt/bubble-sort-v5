(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();var dr,je,$c,Nn,Za,Zc,Jc,Qc,oa,Po,Do,Kc,nr={},eu=[],Yh=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,fr=Array.isArray;function jt(i,e){for(var t in e)i[t]=e[t];return i}function aa(i){i&&i.parentNode&&i.parentNode.removeChild(i)}function ys(i,e,t){var n,r,s,o={};for(s in e)s=="key"?n=e[s]:s=="ref"?r=e[s]:o[s]=e[s];if(arguments.length>2&&(o.children=arguments.length>3?dr.call(arguments,2):t),typeof i=="function"&&i.defaultProps!=null)for(s in i.defaultProps)o[s]===void 0&&(o[s]=i.defaultProps[s]);return $i(i,o,n,r,null)}function $i(i,e,t,n,r){var s={type:i,props:e,key:t,ref:n,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:r??++$c,__i:-1,__u:0};return r==null&&je.vnode!=null&&je.vnode(s),s}function Ms(i){return i.children}function Zi(i,e){this.props=i,this.context=e}function vi(i,e){if(e==null)return i.__?vi(i.__,i.__i+1):null;for(var t;e<i.__k.length;e++)if((t=i.__k[e])!=null&&t.__e!=null)return t.__e;return typeof i.type=="function"?vi(i):null}function tu(i){var e,t;if((i=i.__)!=null&&i.__c!=null){for(i.__e=i.__c.base=null,e=0;e<i.__k.length;e++)if((t=i.__k[e])!=null&&t.__e!=null){i.__e=i.__c.base=t.__e;break}return tu(i)}}function Io(i){(!i.__d&&(i.__d=!0)&&Nn.push(i)&&!os.__r++||Za!=je.debounceRendering)&&((Za=je.debounceRendering)||Zc)(os)}function os(){for(var i,e,t,n,r,s,o,a=1;Nn.length;)Nn.length>a&&Nn.sort(Jc),i=Nn.shift(),a=Nn.length,i.__d&&(t=void 0,r=(n=(e=i).__v).__e,s=[],o=[],e.__P&&((t=jt({},n)).__v=n.__v+1,je.vnode&&je.vnode(t),la(e.__P,t,n,e.__n,e.__P.namespaceURI,32&n.__u?[r]:null,s,r??vi(n),!!(32&n.__u),o),t.__v=n.__v,t.__.__k[t.__i]=t,ru(s,t,o),t.__e!=r&&tu(t)));os.__r=0}function nu(i,e,t,n,r,s,o,a,l,c,u){var h,d,f,g,_,v,m=n&&n.__k||eu,p=e.length;for(l=$h(t,e,m,l,p),h=0;h<p;h++)(f=t.__k[h])!=null&&(d=f.__i==-1?nr:m[f.__i]||nr,f.__i=h,v=la(i,f,d,r,s,o,a,l,c,u),g=f.__e,f.ref&&d.ref!=f.ref&&(d.ref&&ca(d.ref,null,f),u.push(f.ref,f.__c||g,f)),_==null&&g!=null&&(_=g),4&f.__u||d.__k===f.__k?l=iu(f,l,i):typeof f.type=="function"&&v!==void 0?l=v:g&&(l=g.nextSibling),f.__u&=-7);return t.__e=_,l}function $h(i,e,t,n,r){var s,o,a,l,c,u=t.length,h=u,d=0;for(i.__k=new Array(r),s=0;s<r;s++)(o=e[s])!=null&&typeof o!="boolean"&&typeof o!="function"?(l=s+d,(o=i.__k[s]=typeof o=="string"||typeof o=="number"||typeof o=="bigint"||o.constructor==String?$i(null,o,null,null,null):fr(o)?$i(Ms,{children:o},null,null,null):o.constructor==null&&o.__b>0?$i(o.type,o.props,o.key,o.ref?o.ref:null,o.__v):o).__=i,o.__b=i.__b+1,a=null,(c=o.__i=Zh(o,t,l,h))!=-1&&(h--,(a=t[c])&&(a.__u|=2)),a==null||a.__v==null?(c==-1&&(r>u?d--:r<u&&d++),typeof o.type!="function"&&(o.__u|=4)):c!=l&&(c==l-1?d--:c==l+1?d++:(c>l?d--:d++,o.__u|=4))):i.__k[s]=null;if(h)for(s=0;s<u;s++)(a=t[s])!=null&&!(2&a.__u)&&(a.__e==n&&(n=vi(a)),ou(a,a));return n}function iu(i,e,t){var n,r;if(typeof i.type=="function"){for(n=i.__k,r=0;n&&r<n.length;r++)n[r]&&(n[r].__=i,e=iu(n[r],e,t));return e}i.__e!=e&&(e&&i.type&&!t.contains(e)&&(e=vi(i)),t.insertBefore(i.__e,e||null),e=i.__e);do e=e&&e.nextSibling;while(e!=null&&e.nodeType==8);return e}function Fo(i,e){return e=e||[],i==null||typeof i=="boolean"||(fr(i)?i.some(function(t){Fo(t,e)}):e.push(i)),e}function Zh(i,e,t,n){var r,s,o=i.key,a=i.type,l=e[t];if(l===null&&i.key==null||l&&o==l.key&&a==l.type&&!(2&l.__u))return t;if(n>(l!=null&&!(2&l.__u)?1:0))for(r=t-1,s=t+1;r>=0||s<e.length;){if(r>=0){if((l=e[r])&&!(2&l.__u)&&o==l.key&&a==l.type)return r;r--}if(s<e.length){if((l=e[s])&&!(2&l.__u)&&o==l.key&&a==l.type)return s;s++}}return-1}function Ja(i,e,t){e[0]=="-"?i.setProperty(e,t??""):i[e]=t==null?"":typeof t!="number"||Yh.test(e)?t:t+"px"}function Sr(i,e,t,n,r){var s,o;e:if(e=="style")if(typeof t=="string")i.style.cssText=t;else{if(typeof n=="string"&&(i.style.cssText=n=""),n)for(e in n)t&&e in t||Ja(i.style,e,"");if(t)for(e in t)n&&t[e]==n[e]||Ja(i.style,e,t[e])}else if(e[0]=="o"&&e[1]=="n")s=e!=(e=e.replace(Qc,"$1")),o=e.toLowerCase(),e=o in i||e=="onFocusOut"||e=="onFocusIn"?o.slice(2):e.slice(2),i.l||(i.l={}),i.l[e+s]=t,t?n?t.u=n.u:(t.u=oa,i.addEventListener(e,s?Do:Po,s)):i.removeEventListener(e,s?Do:Po,s);else{if(r=="http://www.w3.org/2000/svg")e=e.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(e!="width"&&e!="height"&&e!="href"&&e!="list"&&e!="form"&&e!="tabIndex"&&e!="download"&&e!="rowSpan"&&e!="colSpan"&&e!="role"&&e!="popover"&&e in i)try{i[e]=t??"";break e}catch{}typeof t=="function"||(t==null||t===!1&&e[4]!="-"?i.removeAttribute(e):i.setAttribute(e,e=="popover"&&t==1?"":t))}}function Qa(i){return function(e){if(this.l){var t=this.l[e.type+i];if(e.t==null)e.t=oa++;else if(e.t<t.u)return;return t(je.event?je.event(e):e)}}}function la(i,e,t,n,r,s,o,a,l,c){var u,h,d,f,g,_,v,m,p,S,x,E,L,P,G,Q,U,R=e.type;if(e.constructor!=null)return null;128&t.__u&&(l=!!(32&t.__u),s=[a=e.__e=t.__e]),(u=je.__b)&&u(e);e:if(typeof R=="function")try{if(m=e.props,p="prototype"in R&&R.prototype.render,S=(u=R.contextType)&&n[u.__c],x=u?S?S.props.value:u.__:n,t.__c?v=(h=e.__c=t.__c).__=h.__E:(p?e.__c=h=new R(m,x):(e.__c=h=new Zi(m,x),h.constructor=R,h.render=Qh),S&&S.sub(h),h.props=m,h.state||(h.state={}),h.context=x,h.__n=n,d=h.__d=!0,h.__h=[],h._sb=[]),p&&h.__s==null&&(h.__s=h.state),p&&R.getDerivedStateFromProps!=null&&(h.__s==h.state&&(h.__s=jt({},h.__s)),jt(h.__s,R.getDerivedStateFromProps(m,h.__s))),f=h.props,g=h.state,h.__v=e,d)p&&R.getDerivedStateFromProps==null&&h.componentWillMount!=null&&h.componentWillMount(),p&&h.componentDidMount!=null&&h.__h.push(h.componentDidMount);else{if(p&&R.getDerivedStateFromProps==null&&m!==f&&h.componentWillReceiveProps!=null&&h.componentWillReceiveProps(m,x),!h.__e&&h.shouldComponentUpdate!=null&&h.shouldComponentUpdate(m,h.__s,x)===!1||e.__v==t.__v){for(e.__v!=t.__v&&(h.props=m,h.state=h.__s,h.__d=!1),e.__e=t.__e,e.__k=t.__k,e.__k.some(function(w){w&&(w.__=e)}),E=0;E<h._sb.length;E++)h.__h.push(h._sb[E]);h._sb=[],h.__h.length&&o.push(h);break e}h.componentWillUpdate!=null&&h.componentWillUpdate(m,h.__s,x),p&&h.componentDidUpdate!=null&&h.__h.push(function(){h.componentDidUpdate(f,g,_)})}if(h.context=x,h.props=m,h.__P=i,h.__e=!1,L=je.__r,P=0,p){for(h.state=h.__s,h.__d=!1,L&&L(e),u=h.render(h.props,h.state,h.context),G=0;G<h._sb.length;G++)h.__h.push(h._sb[G]);h._sb=[]}else do h.__d=!1,L&&L(e),u=h.render(h.props,h.state,h.context),h.state=h.__s;while(h.__d&&++P<25);h.state=h.__s,h.getChildContext!=null&&(n=jt(jt({},n),h.getChildContext())),p&&!d&&h.getSnapshotBeforeUpdate!=null&&(_=h.getSnapshotBeforeUpdate(f,g)),Q=u,u!=null&&u.type===Ms&&u.key==null&&(Q=su(u.props.children)),a=nu(i,fr(Q)?Q:[Q],e,t,n,r,s,o,a,l,c),h.base=e.__e,e.__u&=-161,h.__h.length&&o.push(h),v&&(h.__E=h.__=null)}catch(w){if(e.__v=null,l||s!=null)if(w.then){for(e.__u|=l?160:128;a&&a.nodeType==8&&a.nextSibling;)a=a.nextSibling;s[s.indexOf(a)]=null,e.__e=a}else for(U=s.length;U--;)aa(s[U]);else e.__e=t.__e,e.__k=t.__k;je.__e(w,e,t)}else s==null&&e.__v==t.__v?(e.__k=t.__k,e.__e=t.__e):a=e.__e=Jh(t.__e,e,t,n,r,s,o,l,c);return(u=je.diffed)&&u(e),128&e.__u?void 0:a}function ru(i,e,t){for(var n=0;n<t.length;n++)ca(t[n],t[++n],t[++n]);je.__c&&je.__c(e,i),i.some(function(r){try{i=r.__h,r.__h=[],i.some(function(s){s.call(r)})}catch(s){je.__e(s,r.__v)}})}function su(i){return typeof i!="object"||i==null||i.__b&&i.__b>0?i:fr(i)?i.map(su):jt({},i)}function Jh(i,e,t,n,r,s,o,a,l){var c,u,h,d,f,g,_,v=t.props,m=e.props,p=e.type;if(p=="svg"?r="http://www.w3.org/2000/svg":p=="math"?r="http://www.w3.org/1998/Math/MathML":r||(r="http://www.w3.org/1999/xhtml"),s!=null){for(c=0;c<s.length;c++)if((f=s[c])&&"setAttribute"in f==!!p&&(p?f.localName==p:f.nodeType==3)){i=f,s[c]=null;break}}if(i==null){if(p==null)return document.createTextNode(m);i=document.createElementNS(r,p,m.is&&m),a&&(je.__m&&je.__m(e,s),a=!1),s=null}if(p==null)v===m||a&&i.data==m||(i.data=m);else{if(s=s&&dr.call(i.childNodes),v=t.props||nr,!a&&s!=null)for(v={},c=0;c<i.attributes.length;c++)v[(f=i.attributes[c]).name]=f.value;for(c in v)if(f=v[c],c!="children"){if(c=="dangerouslySetInnerHTML")h=f;else if(!(c in m)){if(c=="value"&&"defaultValue"in m||c=="checked"&&"defaultChecked"in m)continue;Sr(i,c,null,f,r)}}for(c in m)f=m[c],c=="children"?d=f:c=="dangerouslySetInnerHTML"?u=f:c=="value"?g=f:c=="checked"?_=f:a&&typeof f!="function"||v[c]===f||Sr(i,c,f,v[c],r);if(u)a||h&&(u.__html==h.__html||u.__html==i.innerHTML)||(i.innerHTML=u.__html),e.__k=[];else if(h&&(i.innerHTML=""),nu(e.type=="template"?i.content:i,fr(d)?d:[d],e,t,n,p=="foreignObject"?"http://www.w3.org/1999/xhtml":r,s,o,s?s[0]:t.__k&&vi(t,0),a,l),s!=null)for(c=s.length;c--;)aa(s[c]);a||(c="value",p=="progress"&&g==null?i.removeAttribute("value"):g!=null&&(g!==i[c]||p=="progress"&&!g||p=="option"&&g!=v[c])&&Sr(i,c,g,v[c],r),c="checked",_!=null&&_!=i[c]&&Sr(i,c,_,v[c],r))}return i}function ca(i,e,t){try{if(typeof i=="function"){var n=typeof i.__u=="function";n&&i.__u(),n&&e==null||(i.__u=i(e))}else i.current=e}catch(r){je.__e(r,t)}}function ou(i,e,t){var n,r;if(je.unmount&&je.unmount(i),(n=i.ref)&&(n.current&&n.current!=i.__e||ca(n,null,e)),(n=i.__c)!=null){if(n.componentWillUnmount)try{n.componentWillUnmount()}catch(s){je.__e(s,e)}n.base=n.__P=null}if(n=i.__k)for(r=0;r<n.length;r++)n[r]&&ou(n[r],e,t||typeof i.type!="function");t||aa(i.__e),i.__c=i.__=i.__e=void 0}function Qh(i,e,t){return this.constructor(i,t)}function Kh(i,e,t){var n,r,s,o;e==document&&(e=document.documentElement),je.__&&je.__(i,e),r=(n=!1)?null:e.__k,s=[],o=[],la(e,i=e.__k=ys(Ms,null,[i]),r||nr,nr,e.namespaceURI,r?null:e.firstChild?dr.call(e.childNodes):null,s,r?r.__e:e.firstChild,n,o),ru(s,i,o)}function ed(i,e,t){var n,r,s,o,a=jt({},i.props);for(s in i.type&&i.type.defaultProps&&(o=i.type.defaultProps),e)s=="key"?n=e[s]:s=="ref"?r=e[s]:a[s]=e[s]===void 0&&o!=null?o[s]:e[s];return arguments.length>2&&(a.children=arguments.length>3?dr.call(arguments,2):t),$i(i.type,a,n||i.key,r||i.ref,null)}function td(i){function e(t){var n,r;return this.getChildContext||(n=new Set,(r={})[e.__c]=this,this.getChildContext=function(){return r},this.componentWillUnmount=function(){n=null},this.shouldComponentUpdate=function(s){this.props.value!=s.value&&n.forEach(function(o){o.__e=!0,Io(o)})},this.sub=function(s){n.add(s);var o=s.componentWillUnmount;s.componentWillUnmount=function(){n&&n.delete(s),o&&o.call(s)}}),t.children}return e.__c="__cC"+Kc++,e.__=i,e.Provider=e.__l=(e.Consumer=function(t,n){return t.children(n)}).contextType=e,e}dr=eu.slice,je={__e:function(i,e,t,n){for(var r,s,o;e=e.__;)if((r=e.__c)&&!r.__)try{if((s=r.constructor)&&s.getDerivedStateFromError!=null&&(r.setState(s.getDerivedStateFromError(i)),o=r.__d),r.componentDidCatch!=null&&(r.componentDidCatch(i,n||{}),o=r.__d),o)return r.__E=r}catch(a){i=a}throw i}},$c=0,Zi.prototype.setState=function(i,e){var t;t=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=jt({},this.state),typeof i=="function"&&(i=i(jt({},t),this.props)),i&&jt(t,i),i!=null&&this.__v&&(e&&this._sb.push(e),Io(this))},Zi.prototype.forceUpdate=function(i){this.__v&&(this.__e=!0,i&&this.__h.push(i),Io(this))},Zi.prototype.render=Ms,Nn=[],Zc=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Jc=function(i,e){return i.__v.__b-e.__v.__b},os.__r=0,Qc=/(PointerCapture)$|Capture$/i,oa=0,Po=Qa(!1),Do=Qa(!0),Kc=0;var au=function(i,e,t,n){var r;e[0]=0;for(var s=1;s<e.length;s++){var o=e[s++],a=e[s]?(e[0]|=o?1:2,t[e[s++]]):e[++s];o===3?n[0]=a:o===4?n[1]=Object.assign(n[1]||{},a):o===5?(n[1]=n[1]||{})[e[++s]]=a:o===6?n[1][e[++s]]+=a+"":o?(r=i.apply(a,au(i,a,t,["",null])),n.push(r),a[0]?e[0]|=2:(e[s-2]=0,e[s]=r)):n.push(a)}return n},Ka=new Map;function nd(i){var e=Ka.get(this);return e||(e=new Map,Ka.set(this,e)),(e=au(this,e.get(i)||(e.set(i,e=function(t){for(var n,r,s=1,o="",a="",l=[0],c=function(d){s===1&&(d||(o=o.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?l.push(0,d,o):s===3&&(d||o)?(l.push(3,d,o),s=2):s===2&&o==="..."&&d?l.push(4,d,0):s===2&&o&&!d?l.push(5,0,!0,o):s>=5&&((o||!d&&s===5)&&(l.push(s,0,o,r),s=6),d&&(l.push(s,d,0,r),s=6)),o=""},u=0;u<t.length;u++){u&&(s===1&&c(),c(u));for(var h=0;h<t[u].length;h++)n=t[u][h],s===1?n==="<"?(c(),l=[l],s=3):o+=n:s===4?o==="--"&&n===">"?(s=1,o=""):o=n+o[0]:a?n===a?a="":o+=n:n==='"'||n==="'"?a=n:n===">"?(c(),s=1):s&&(n==="="?(s=5,r=o,o=""):n==="/"&&(s<5||t[u][h+1]===">")?(c(),s===3&&(l=l[0]),s=l,(l=l[0]).push(2,0,s),s=0):n===" "||n==="	"||n===`
`||n==="\r"?(c(),s=2):o+=n),s===3&&o==="!--"&&(s=4,l=l[0])}return c(),l}(i)),e),arguments,[])).length>1?e:e[0]}var pr=nd.bind(ys),id={};function lu(i,e){for(var t in e)i[t]=e[t];return i}function cu(i,e,t){var n=/(?:\?([^#]*))?(#.*)?$/,r=i.match(n),s={},o;if(r&&r[1])for(var a=r[1].split("&"),l=0;l<a.length;l++){var c=a[l].split("=");s[decodeURIComponent(c[0])]=decodeURIComponent(c.slice(1).join("="))}i=No(i.replace(n,"")),e=No(e||"");for(var u=Math.max(i.length,e.length),h=0;h<u;h++)if(e[h]&&e[h].charAt(0)===":"){var d=e[h].replace(/(^:|[+*?]+$)/g,""),f=(e[h].match(/[+*?]+$/)||id)[0]||"",g=~f.indexOf("+"),_=~f.indexOf("*"),v=i[h]||"";if(!v&&!_&&(f.indexOf("?")<0||g)){o=!1;break}if(s[d]=decodeURIComponent(v),g||_){s[d]=i.slice(h).map(decodeURIComponent).join("/");break}}else if(e[h]!==i[h]){o=!1;break}return t.default!==!0&&o===!1?!1:s}function rd(i,e){return i.rank<e.rank?1:i.rank>e.rank?-1:i.index-e.index}function sd(i,e){return i.index=e,i.rank=ld(i),i.props}function No(i){return i.replace(/(^\/+|\/+$)/g,"").split("/")}function od(i){return i.charAt(0)==":"?1+"*+?".indexOf(i.charAt(i.length-1))||4:5}function ad(i){return No(i).map(od).join("")}function ld(i){return i.props.default?0:ad(i.props.path)}var St=null,Bn=[],Bo=[],cd={};function ud(i,e){e===void 0&&(e="push"),St&&St[e]?St[e](i):typeof history<"u"&&history[e+"State"]&&history[e+"State"](null,null,i)}function ua(){var i;return St&&St.location?i=St.location:St&&St.getCurrentLocation?i=St.getCurrentLocation():i=typeof location<"u"?location:cd,""+(i.pathname||"")+(i.search||"")}function uu(i,e){return e===void 0&&(e=!1),typeof i!="string"&&i.url&&(e=i.replace,i=i.url),hd(i)&&ud(i,e?"replace":"push"),hu(i)}function hd(i){for(var e=Bn.length;e--;)if(Bn[e].canRoute(i))return!0;return!1}function hu(i){for(var e=!1,t=0;t<Bn.length;t++)Bn[t].routeTo(i)===!0&&(e=!0);for(var n=Bo.length;n--;)Bo[n](i);return e}function du(i){if(!(!i||!i.getAttribute)){var e=i.getAttribute("href"),t=i.getAttribute("target");if(!(!e||!e.match(/^\//g)||t&&!t.match(/^_?self$/i)))return uu(e)}}function dd(i){if(!(i.ctrlKey||i.metaKey||i.altKey||i.shiftKey||i.button!==0))return du(i.currentTarget||i.target||this),fu(i)}function fu(i){return i&&(i.stopImmediatePropagation&&i.stopImmediatePropagation(),i.stopPropagation&&i.stopPropagation(),i.preventDefault()),!1}function fd(i){if(!(i.ctrlKey||i.metaKey||i.altKey||i.shiftKey||i.button!==0)){var e=i.target;do if(String(e.nodeName).toUpperCase()==="A"&&e.getAttribute("href")){if(e.hasAttribute("native"))return;if(du(e))return fu(i)}while(e=e.parentNode)}}var el=!1;function pd(){el||(typeof addEventListener=="function"&&(St||addEventListener("popstate",function(){hu(ua())}),addEventListener("click",fd)),el=!0)}var Jt=function(i){function e(t){i.call(this,t),t.history&&(St=t.history),this.state={url:t.url||ua()},pd()}return i&&(e.__proto__=i),e.prototype=Object.create(i&&i.prototype),e.prototype.constructor=e,e.prototype.shouldComponentUpdate=function(n){return n.static!==!0?!0:n.url!==this.props.url||n.onChange!==this.props.onChange},e.prototype.canRoute=function(n){var r=Fo(this.props.children);return this.getMatchingChildren(r,n,!1).length>0},e.prototype.routeTo=function(n){this.setState({url:n});var r=this.canRoute(n);return this.updating||this.forceUpdate(),r},e.prototype.componentWillMount=function(){Bn.push(this),this.updating=!0},e.prototype.componentDidMount=function(){var n=this;St&&(this.unlisten=St.listen(function(r){n.routeTo(""+(r.pathname||"")+(r.search||""))})),this.updating=!1},e.prototype.componentWillUnmount=function(){typeof this.unlisten=="function"&&this.unlisten(),Bn.splice(Bn.indexOf(this),1)},e.prototype.componentWillUpdate=function(){this.updating=!0},e.prototype.componentDidUpdate=function(){this.updating=!1},e.prototype.getMatchingChildren=function(n,r,s){return n.filter(sd).sort(rd).map(function(o){var a=cu(r,o.props.path,o.props);if(a){if(s!==!1){var l={url:r,matches:a};return lu(l,a),delete l.ref,delete l.key,ed(o,l)}return o}}).filter(Boolean)},e.prototype.render=function(n,r){var s=n.children,o=n.onChange,a=r.url,l=this.getMatchingChildren(Fo(s),a,!0),c=l[0]||null,u=this.previousUrl;return a!==u&&(this.previousUrl=a,typeof o=="function"&&o({router:this,url:a,previous:u,active:l,current:c})),c},e}(Zi),md=function(i){return ys("a",lu({onClick:dd},i))},gd=function(i){return ys(i.component,i)};Jt.subscribers=Bo;Jt.getCurrentUrl=ua;Jt.route=uu;Jt.Router=Jt;Jt.Route=gd;Jt.Link=md;Jt.exec=cu;let zo=!1;(typeof process>"u"||process.release.name!=="node")&&(zo=window.REMEMBER_ME??zo);const bs={REMEMBER_ME:zo};var as,et,Vs,tl,nl=0,pu=[],nt=je,il=nt.__b,rl=nt.__r,sl=nt.diffed,ol=nt.__c,al=nt.unmount,ll=nt.__;function mu(i,e){nt.__h&&nt.__h(et,i,nl||e),nl=0;var t=et.__H||(et.__H={__:[],__h:[]});return i>=t.__.length&&t.__.push({}),t.__[i]}function gu(i,e,t){var n=mu(as++,2);if(n.t=i,!n.__c&&(n.__=[yd(void 0,e),function(a){var l=n.__N?n.__N[0]:n.__[0],c=n.t(l,a);l!==c&&(n.__N=[c,n.__[1]],n.__c.setState({}))}],n.__c=et,!et.__f)){var r=function(a,l,c){if(!n.__c.__H)return!0;var u=n.__c.__H.__.filter(function(d){return!!d.__c});if(u.every(function(d){return!d.__N}))return!s||s.call(this,a,l,c);var h=n.__c.props!==a;return u.forEach(function(d){if(d.__N){var f=d.__[0];d.__=d.__N,d.__N=void 0,f!==d.__[0]&&(h=!0)}}),s&&s.call(this,a,l,c)||h};et.__f=!0;var s=et.shouldComponentUpdate,o=et.componentWillUpdate;et.componentWillUpdate=function(a,l,c){if(this.__e){var u=s;s=void 0,r(a,l,c),s=u}o&&o.call(this,a,l,c)},et.shouldComponentUpdate=r}return n.__N||n.__}function _u(i,e){var t=mu(as++,3);!nt.__s&&xd(t.__H,e)&&(t.__=i,t.u=e,et.__H.__h.push(t))}function _d(){for(var i;i=pu.shift();)if(i.__P&&i.__H)try{i.__H.__h.forEach(rs),i.__H.__h.forEach(Oo),i.__H.__h=[]}catch(e){i.__H.__h=[],nt.__e(e,i.__v)}}nt.__b=function(i){et=null,il&&il(i)},nt.__=function(i,e){i&&e.__k&&e.__k.__m&&(i.__m=e.__k.__m),ll&&ll(i,e)},nt.__r=function(i){rl&&rl(i),as=0;var e=(et=i.__c).__H;e&&(Vs===et?(e.__h=[],et.__h=[],e.__.forEach(function(t){t.__N&&(t.__=t.__N),t.u=t.__N=void 0})):(e.__h.forEach(rs),e.__h.forEach(Oo),e.__h=[],as=0)),Vs=et},nt.diffed=function(i){sl&&sl(i);var e=i.__c;e&&e.__H&&(e.__H.__h.length&&(pu.push(e)!==1&&tl===nt.requestAnimationFrame||((tl=nt.requestAnimationFrame)||vd)(_d)),e.__H.__.forEach(function(t){t.u&&(t.__H=t.u),t.u=void 0})),Vs=et=null},nt.__c=function(i,e){e.some(function(t){try{t.__h.forEach(rs),t.__h=t.__h.filter(function(n){return!n.__||Oo(n)})}catch(n){e.some(function(r){r.__h&&(r.__h=[])}),e=[],nt.__e(n,t.__v)}}),ol&&ol(i,e)},nt.unmount=function(i){al&&al(i);var e,t=i.__c;t&&t.__H&&(t.__H.__.forEach(function(n){try{rs(n)}catch(r){e=r}}),t.__H=void 0,e&&nt.__e(e,t.__v))};var cl=typeof requestAnimationFrame=="function";function vd(i){var e,t=function(){clearTimeout(n),cl&&cancelAnimationFrame(e),setTimeout(i)},n=setTimeout(t,35);cl&&(e=requestAnimationFrame(t))}function rs(i){var e=et,t=i.__c;typeof t=="function"&&(i.__c=void 0,t()),et=e}function Oo(i){var e=et;i.__c=i.__(),et=e}function xd(i,e){return!i||i.length!==e.length||e.some(function(t,n){return t!==i[n]})}function yd(i,e){return typeof e=="function"?e(i):e}var vu=Symbol.for("immer-nothing"),ul=Symbol.for("immer-draftable"),At=Symbol.for("immer-state");function Bt(i,...e){throw new Error(`[Immer] minified error nr: ${i}. Full error at: https://bit.ly/3cXEKWf`)}var xi=Object.getPrototypeOf;function yi(i){return!!i&&!!i[At]}function kn(i){var e;return i?xu(i)||Array.isArray(i)||!!i[ul]||!!((e=i.constructor)!=null&&e[ul])||Ss(i)||Ts(i):!1}var Md=Object.prototype.constructor.toString();function xu(i){if(!i||typeof i!="object")return!1;const e=xi(i);if(e===null)return!0;const t=Object.hasOwnProperty.call(e,"constructor")&&e.constructor;return t===Object?!0:typeof t=="function"&&Function.toString.call(t)===Md}function ls(i,e){ws(i)===0?Reflect.ownKeys(i).forEach(t=>{e(t,i[t],i)}):i.forEach((t,n)=>e(n,t,i))}function ws(i){const e=i[At];return e?e.type_:Array.isArray(i)?1:Ss(i)?2:Ts(i)?3:0}function Uo(i,e){return ws(i)===2?i.has(e):Object.prototype.hasOwnProperty.call(i,e)}function yu(i,e,t){const n=ws(i);n===2?i.set(e,t):n===3?i.add(t):i[e]=t}function bd(i,e){return i===e?i!==0||1/i===1/e:i!==i&&e!==e}function Ss(i){return i instanceof Map}function Ts(i){return i instanceof Set}function In(i){return i.copy_||i.base_}function ko(i,e){if(Ss(i))return new Map(i);if(Ts(i))return new Set(i);if(Array.isArray(i))return Array.prototype.slice.call(i);const t=xu(i);if(e===!0||e==="class_only"&&!t){const n=Object.getOwnPropertyDescriptors(i);delete n[At];let r=Reflect.ownKeys(n);for(let s=0;s<r.length;s++){const o=r[s],a=n[o];a.writable===!1&&(a.writable=!0,a.configurable=!0),(a.get||a.set)&&(n[o]={configurable:!0,writable:!0,enumerable:a.enumerable,value:i[o]})}return Object.create(xi(i),n)}else{const n=xi(i);if(n!==null&&t)return{...i};const r=Object.create(n);return Object.assign(r,i)}}function ha(i,e=!1){return Es(i)||yi(i)||!kn(i)||(ws(i)>1&&(i.set=i.add=i.clear=i.delete=wd),Object.freeze(i),e&&Object.entries(i).forEach(([t,n])=>ha(n,!0))),i}function wd(){Bt(2)}function Es(i){return Object.isFrozen(i)}var Sd={};function Hn(i){const e=Sd[i];return e||Bt(0,i),e}var ir;function Mu(){return ir}function Td(i,e){return{drafts_:[],parent_:i,immer_:e,canAutoFreeze_:!0,unfinalizedDrafts_:0}}function hl(i,e){e&&(Hn("Patches"),i.patches_=[],i.inversePatches_=[],i.patchListener_=e)}function Ho(i){Vo(i),i.drafts_.forEach(Ed),i.drafts_=null}function Vo(i){i===ir&&(ir=i.parent_)}function dl(i){return ir=Td(ir,i)}function Ed(i){const e=i[At];e.type_===0||e.type_===1?e.revoke_():e.revoked_=!0}function fl(i,e){e.unfinalizedDrafts_=e.drafts_.length;const t=e.drafts_[0];return i!==void 0&&i!==t?(t[At].modified_&&(Ho(e),Bt(4)),kn(i)&&(i=cs(e,i),e.parent_||us(e,i)),e.patches_&&Hn("Patches").generateReplacementPatches_(t[At].base_,i,e.patches_,e.inversePatches_)):i=cs(e,t,[]),Ho(e),e.patches_&&e.patchListener_(e.patches_,e.inversePatches_),i!==vu?i:void 0}function cs(i,e,t){if(Es(e))return e;const n=e[At];if(!n)return ls(e,(r,s)=>pl(i,n,e,r,s,t)),e;if(n.scope_!==i)return e;if(!n.modified_)return us(i,n.base_,!0),n.base_;if(!n.finalized_){n.finalized_=!0,n.scope_.unfinalizedDrafts_--;const r=n.copy_;let s=r,o=!1;n.type_===3&&(s=new Set(r),r.clear(),o=!0),ls(s,(a,l)=>pl(i,n,r,a,l,t,o)),us(i,r,!1),t&&i.patches_&&Hn("Patches").generatePatches_(n,t,i.patches_,i.inversePatches_)}return n.copy_}function pl(i,e,t,n,r,s,o){if(yi(r)){const a=s&&e&&e.type_!==3&&!Uo(e.assigned_,n)?s.concat(n):void 0,l=cs(i,r,a);if(yu(t,n,l),yi(l))i.canAutoFreeze_=!1;else return}else o&&t.add(r);if(kn(r)&&!Es(r)){if(!i.immer_.autoFreeze_&&i.unfinalizedDrafts_<1)return;cs(i,r),(!e||!e.scope_.parent_)&&typeof n!="symbol"&&Object.prototype.propertyIsEnumerable.call(t,n)&&us(i,r)}}function us(i,e,t=!1){!i.parent_&&i.immer_.autoFreeze_&&i.canAutoFreeze_&&ha(e,t)}function Ad(i,e){const t=Array.isArray(i),n={type_:t?1:0,scope_:e?e.scope_:Mu(),modified_:!1,finalized_:!1,assigned_:{},parent_:e,base_:i,draft_:null,copy_:null,revoke_:null,isManual_:!1};let r=n,s=da;t&&(r=[n],s=rr);const{revoke:o,proxy:a}=Proxy.revocable(r,s);return n.draft_=a,n.revoke_=o,a}var da={get(i,e){if(e===At)return i;const t=In(i);if(!Uo(t,e))return Cd(i,t,e);const n=t[e];return i.finalized_||!kn(n)?n:n===Gs(i.base_,e)?(Ws(i),i.copy_[e]=Wo(n,i)):n},has(i,e){return e in In(i)},ownKeys(i){return Reflect.ownKeys(In(i))},set(i,e,t){const n=bu(In(i),e);if(n!=null&&n.set)return n.set.call(i.draft_,t),!0;if(!i.modified_){const r=Gs(In(i),e),s=r==null?void 0:r[At];if(s&&s.base_===t)return i.copy_[e]=t,i.assigned_[e]=!1,!0;if(bd(t,r)&&(t!==void 0||Uo(i.base_,e)))return!0;Ws(i),Go(i)}return i.copy_[e]===t&&(t!==void 0||e in i.copy_)||Number.isNaN(t)&&Number.isNaN(i.copy_[e])||(i.copy_[e]=t,i.assigned_[e]=!0),!0},deleteProperty(i,e){return Gs(i.base_,e)!==void 0||e in i.base_?(i.assigned_[e]=!1,Ws(i),Go(i)):delete i.assigned_[e],i.copy_&&delete i.copy_[e],!0},getOwnPropertyDescriptor(i,e){const t=In(i),n=Reflect.getOwnPropertyDescriptor(t,e);return n&&{writable:!0,configurable:i.type_!==1||e!=="length",enumerable:n.enumerable,value:t[e]}},defineProperty(){Bt(11)},getPrototypeOf(i){return xi(i.base_)},setPrototypeOf(){Bt(12)}},rr={};ls(da,(i,e)=>{rr[i]=function(){return arguments[0]=arguments[0][0],e.apply(this,arguments)}});rr.deleteProperty=function(i,e){return rr.set.call(this,i,e,void 0)};rr.set=function(i,e,t){return da.set.call(this,i[0],e,t,i[0])};function Gs(i,e){const t=i[At];return(t?In(t):i)[e]}function Cd(i,e,t){var r;const n=bu(e,t);return n?"value"in n?n.value:(r=n.get)==null?void 0:r.call(i.draft_):void 0}function bu(i,e){if(!(e in i))return;let t=xi(i);for(;t;){const n=Object.getOwnPropertyDescriptor(t,e);if(n)return n;t=xi(t)}}function Go(i){i.modified_||(i.modified_=!0,i.parent_&&Go(i.parent_))}function Ws(i){i.copy_||(i.copy_=ko(i.base_,i.scope_.immer_.useStrictShallowCopy_))}var Ld=class{constructor(i){this.autoFreeze_=!0,this.useStrictShallowCopy_=!1,this.produce=(e,t,n)=>{if(typeof e=="function"&&typeof t!="function"){const s=t;t=e;const o=this;return function(l=s,...c){return o.produce(l,u=>t.call(this,u,...c))}}typeof t!="function"&&Bt(6),n!==void 0&&typeof n!="function"&&Bt(7);let r;if(kn(e)){const s=dl(this),o=Wo(e,void 0);let a=!0;try{r=t(o),a=!1}finally{a?Ho(s):Vo(s)}return hl(s,n),fl(r,s)}else if(!e||typeof e!="object"){if(r=t(e),r===void 0&&(r=e),r===vu&&(r=void 0),this.autoFreeze_&&ha(r,!0),n){const s=[],o=[];Hn("Patches").generateReplacementPatches_(e,r,s,o),n(s,o)}return r}else Bt(1,e)},this.produceWithPatches=(e,t)=>{if(typeof e=="function")return(o,...a)=>this.produceWithPatches(o,l=>e(l,...a));let n,r;return[this.produce(e,t,(o,a)=>{n=o,r=a}),n,r]},typeof(i==null?void 0:i.autoFreeze)=="boolean"&&this.setAutoFreeze(i.autoFreeze),typeof(i==null?void 0:i.useStrictShallowCopy)=="boolean"&&this.setUseStrictShallowCopy(i.useStrictShallowCopy)}createDraft(i){kn(i)||Bt(8),yi(i)&&(i=Rd(i));const e=dl(this),t=Wo(i,void 0);return t[At].isManual_=!0,Vo(e),t}finishDraft(i,e){const t=i&&i[At];(!t||!t.isManual_)&&Bt(9);const{scope_:n}=t;return hl(n,e),fl(void 0,n)}setAutoFreeze(i){this.autoFreeze_=i}setUseStrictShallowCopy(i){this.useStrictShallowCopy_=i}applyPatches(i,e){let t;for(t=e.length-1;t>=0;t--){const r=e[t];if(r.path.length===0&&r.op==="replace"){i=r.value;break}}t>-1&&(e=e.slice(t+1));const n=Hn("Patches").applyPatches_;return yi(i)?n(i,e):this.produce(i,r=>n(r,e))}};function Wo(i,e){const t=Ss(i)?Hn("MapSet").proxyMap_(i,e):Ts(i)?Hn("MapSet").proxySet_(i,e):Ad(i,e);return(e?e.scope_:Mu()).drafts_.push(t),t}function Rd(i){return yi(i)||Bt(10,i),wu(i)}function wu(i){if(!kn(i)||Es(i))return i;const e=i[At];let t;if(e){if(!e.modified_)return e.base_;e.finalized_=!0,t=ko(i,e.scope_.immer_.useStrictShallowCopy_)}else t=ko(i,!0);return ls(t,(n,r)=>{yu(t,n,wu(r))}),e&&(e.finalized_=!1),t}var Ct=new Ld,Pd=Ct.produce;Ct.produceWithPatches.bind(Ct);Ct.setAutoFreeze.bind(Ct);Ct.setUseStrictShallowCopy.bind(Ct);Ct.applyPatches.bind(Ct);Ct.createDraft.bind(Ct);Ct.finishDraft.bind(Ct);const Dd=(i,e=bs.REMEMBER_ME)=>typeof process>"u"||process.release.name!=="node"?typeof e<"u"&&e===!0?localStorage.getItem(i):sessionStorage.getItem(i):"{}",Id=(i,e,t=bs.REMEMBER_ME)=>{(typeof process>"u"||process.release.name!=="node")&&(typeof t<"u"&&t===!0?(sessionStorage.clear(),localStorage.setItem(i,e)):(localStorage.clear(),sessionStorage.setItem(i,e)))},Fd=(i=bs.REMEMBER_ME)=>{(typeof process>"u"||process.release.name!=="node")&&(typeof i<"u"&&i===!0?localStorage.clear():sessionStorage.clear())},Tr={getItem:Dd,setItem:Id,clear:Fd},ml=td([{},()=>{}]),Nd=(i,e)=>Pd(i,t=>{let n;e.type==="add"&&(n=i.count||e.payload,n++,t.count=n),e.type==="subtract"&&(n=i.count||e.payload,n--,t.count=n),e.type==="reset"&&(t.count=e.payload.count)}),gl=i=>{const[e,t]=gu(Nd,{});if(typeof process>"u"||process.release.name!=="node"){if(JSON.stringify(e)===JSON.stringify({})){let n=Tr.getItem("state",e.rememberme);if(JSON.stringify(e)===JSON.stringify({})&&(typeof n>"u"||n===null)&&(n=Tr.getItem("state",!0)),typeof n<"u"&&n!==null)try{t({type:"reset",payload:JSON.parse(n)})}catch{Tr.clear(e.rememberme)}}JSON.stringify(e)!==JSON.stringify({})&&Tr.setItem("state",JSON.stringify(e),bs.REMEMBER_ME)}return pr`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Ql(){const i=new $(1,1);return new Is({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null},texelSize:{value:i},inputEncoding:{value:ms[Ot]}},vertexShader:Ma(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Kl(){return new Is({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},inputEncoding:{value:ms[Ot]}},vertexShader:Ma(),fragmentShader:`
...
void main() {
  ...
  `},V0=(i,e)=>{switch(e.type){case"CHANGE_PARAM":return{...i,[e.payload.param]:e.payload.value};default:return{...i}}};var er=function(){var i=0,e=document.createElement("div");e.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",e.addEventListener("click",function(u){u.preventDefault(),n(++i%e.children.length)},!1);function t(u){return e.appendChild(u.dom),u}function n(u){for(var h=0;h<e.children.length;h++)e.children[h].style.display=h===u?"block":"none";i=u}var r=(performance||Date).now(),s=r,o=0,a=t(new er.Panel("FPS","#0ff","#002")),l=t(new er.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var c=t(new er.Panel("MB","#f08","#201"));return n(0),{REVISION:16,dom:e,addPanel:t,showPanel:n,begin:function(){r=(performance||Date).now()},end:function(){o++;var u=(performance||Date).now();if(l.update(u-r,200),u>=s+1e3&&(a.update(o*1e3/(u-s),100),s=u,o=0,c)){var h=performance.memory;c.update(h.usedJSHeapSize/1048576,h.jsHeapSizeLimit/1048576)}return u},update:function(){r=this.end()},domElement:e,setMode:n}};er.Panel=function(i,e,t){var n=1/0,r=0,s=Math.round,o=s(window.devicePixelRatio||1),a=80*o,l=48*o,c=3*o,u=2*o,h=3*o,d=15*o,f=74*o,g=30*o,_=document.createElement("canvas");_.width=a,_.height=l,_.style.cssText="width:80px;height:48px";var v=_.getContext("2d");return v.font="bold "+9*o+"px Helvetica,Arial,sans-serif",v.textBaseline="top",v.fillStyle=t,v.fillRect(0,0,a,l),v.fillStyle=e,v.fillText(i,c,u),v.fillRect(h,d,f,g),v.fillStyle=t,v.globalAlpha=.9,v.fillRect(h,d,f,g),{dom:_,update:function(m,p){n=Math.min(n,m),r=Math.max(r,m),v.fillStyle=t,v.globalAlpha=1,v.fillRect(0,0,a,d),v.fillStyle=e,v.fillText(s(m)+" "+i+" ("+s(n)+"-"+s(r)+")",c,u),v.drawImage(_,h+o,d,f-o,g,h,d,f-o,g),v.fillRect(h+f-o,d,o,g),v.fillStyle=t,v.globalAlpha=.9,v.fillRect(h+f-o,d,o,s((1-m/p)*g))}}};const Th=()=>{const i=new er;return i.setMode(0),i.domElement.style.position="absolute",i.domElement.style.left="0",i.domElement.style.top="0",i},G0=(i,e,t={})=>{const n=document.getElementById("ARButton");n!==null&&n.remove();let r=null;const s=document.createElement("button");function o(){async function u(d){d.addEventListener("end",h),"xr"in navigator&&(e.xr.setReferenceSpaceType("local"),await e.xr.setSession(d),s.textContent="STOP AR",s.style.display="",r=d)}function h(){r!==null&&(r.removeEventListener("end",h),window.location.assign(i))}s.style.display="",s.style.cursor="pointer",s.style.left="calc(50% - 50px)",s.style.width="100px",s.textContent="START AR",s.onmouseenter=function(){s.style.opacity="1.0"},s.onmouseleave=function(){s.style.opacity="0.5"},s.onclick=function(){r===null?"xr"in navigator&&navigator.xr.requestSession("immersive-ar",t).then(u):r.end()}}function a(){s.style.display="",s.style.cursor="auto",s.style.left="calc(50% - 75px)",s.style.width="150px",s.onmouseenter=null,s.onmouseleave=null,s.onclick=null}function l(){a(),s.textContent="AR NOT SUPPORTED"}function c(u){u.style.position="absolute",u.style.bottom="20px",u.style.padding="12px 6px",u.style.border="1px solid #fff",u.style.borderRadius="4px",u.style.background="rgba(0,0,0,0.1)",u.style.color="#fff",u.style.font="normal 13px sans-serif",u.style.textAlign="center",u.style.opacity="0.5",u.style.outline="none",u.style.zIndex="10000"}if("xr"in navigator)return s.id="ARButton",s.style.display="none",c(s),navigator.xr.isSessionSupported("immersive-ar").then(function(u){u?o():l()}).catch(l),s;{const u=document.createElement("a");return window.isSecureContext===!1?(u.href=document.location.href.replace(/^http:/,"https:"),u.innerHTML="WEBXR NEEDS HTTPS"):(u.href="https://immersiveweb.dev/",u.innerHTML="WEBXR NOT AVAILABLE"),u.style.left="calc(50% - 90px)",u.style.width="180px",u.style.textDecoration="none",c(u),u}},W0={createButton:G0},q0=(i,e,t)=>()=>{i.aspect=t.innerWidth/t.innerHeight,i.updateProjectionMatrix(),e.setSize(t.innerWidth,t.innerHeight)},X0=(i,e,t,n,r,s,o)=>{const a=t/100,l=n/100,c=r/100,u=new fi,h=e*i,d=Array.from({length:h},()=>255-Math.ceil(255*Math.random())).sort((_,v)=>_-v),f=[];let g=0;for(let _=0;_<e;_++)for(let v=0;v<i;v++){const m=d[g++],p=new Pi(a,l,c),S=new _r({color:`rgb(${m},${m},${m})`}),x=new mt(p,S);x.position.z=v*c,x.position.y=_*l,x.bubble_value=m,x.castShadow=!0,u.add(x),f.push(x)}return s.add(u),{pixelGridGroup:u,pixelGridCubes:f}},j0=(i,e)=>{for(let t=i.length-1;t>0;t--){const n=Math.floor(e()*(t+1)),r=i[t];i[t]=i[n],i[n]=r}return i},Y0=(i,e)=>{if(i&&i.material&&i.material.color&&typeof i.material.color.setRGB=="function"){const t=Math.max(0,Math.min(255,e))/255;i.material.color.setRGB(t,t,t);return}i&&i.material&&i.material.color&&typeof i.material.color.setStyle=="function"&&i.material.color.setStyle(`rgb(${e},${e},${e})`)},$0=(i,e=Math.random)=>{if(!i||!Array.isArray(i.pixelGrid))return i;const t=i.pixelGrid.map(n=>n&&n.bubble_value);j0(t,e);for(let n=0;n<i.pixelGrid.length;n++){const r=i.pixelGrid[n],s=t[n];r&&(r.bubble_value=s,Y0(r,s))}return i},Z0=(i,e={})=>{if(!i)return null;const{delayMs:t=1e4,setTimeoutFn:n=setTimeout,clearTimeoutFn:r=clearTimeout,unsortFn:s}=e;return i.unsortTimeoutId!=null&&typeof r=="function"&&r(i.unsortTimeoutId),i.unsortTimeoutId=n(()=>{typeof s=="function"?s(i):$0(i)},t),i.unsortTimeoutId},J0=(i,e,t,n,r,s,o,a,l)=>()=>{if(i.reticle.visible&&(i.active=!1),e.active===void 0||e.active===!1){const{pixelGridGroup:c,pixelGridCubes:u}=X0(t,n,r,s,o,a);e.pixelGrid=u,e.pixelGridGroup=c,e.moving=!1,e.active=!0,e.currentIndex=0,Z0(e);const h=new A;l.getWorldDirection(h);const d=Math.atan2(h.x,h.z);e.pixelGridGroup.rotateY(d),c.position.setFromMatrixPosition(i.reticle.matrix)}},Q0=(i,e,t,n)=>{let r=!0,s=!0;const o=i.currentIndex,a=i.currentIndex+1,l=i.pixelGrid[o],c=i.pixelGrid[a];if(i.moving===!1){if(c===void 0)return i.active,i.currentIndex=0,i;if(l.bubble_value>c.bubble_value){if(i.moving===!1){const u={z:l.position.z,y:l.position.y};i.moving=!0,n({targets:[l.position],x:[{value:l.position.x-2*t,duration:1e3/e/2,delay:0},{value:l.position.x,duration:1e3/e,delay:0}],z:[{value:c.position.z,duration:1e3/e,delay:0}],y:[{value:c.position.y,duration:1e3/e,delay:0}],delay:500,easing:"easeInOutCirc",complete:function(h){if(r=!1,s===!1)return i.moving=!1,i.currentIndex=a,i.pixelGrid[o]=c,i.pixelGrid[a]=l,i}}),n({targets:[c.position],x:[{value:c.position.x+2*t,duration:1e3/e/2,delay:0},{value:c.position.x,duration:1e3/e,delay:0}],z:[{value:u.z,duration:1e3/e,delay:0}],y:[{value:u.y,duration:1e3/e,delay:0}],delay:500,easing:"easeInOutCirc",complete:function(h){if(s=!1,r===!1)return i.moving=!1,i.currentIndex=a,i.pixelGrid[o]=c,i.pixelGrid[a]=l,i}})}}else i.currentIndex=a}return i},K0=async i=>{const{stats:e,scene:t,camera:n,renderer:r,reticleStuff:s,cubes:o}=i,a=r.xr.getSession(),l=await a.requestReferenceSpace("viewer");return s.hitTestSource=await a.requestHitTestSource({space:l}),s.localSpace=await a.requestReferenceSpace("local"),s.hitTestSourceInitialized=!0,a.addEventListener("end",()=>{s.hitTestSourceInitialized=!1,s.hitTestSource=null}),{stats:e,scene:t,camera:n,renderer:r,reticleStuff:s,cubes:o}};var Eh={update:null,begin:null,loopBegin:null,changeBegin:null,change:null,changeComplete:null,loopComplete:null,complete:null,loop:1,direction:"normal",autoplay:!0,timelineOffset:0},za={duration:1e3,delay:0,endDelay:0,easing:"easeOutElastic(1, .5)",round:0},ey=["translateX","translateY","translateZ","rotate","rotateX","rotateY","rotateZ","scale","scaleX","scaleY","scaleZ","skew","skewX","skewY","perspective","matrix","matrix3d"],xs={CSS:{},springs:{}};function Yt(i,e,t){return Math.min(Math.max(i,e),t)}function tr(i,e){return i.indexOf(e)>-1}function Ro(i,e){return i.apply(null,e)}var pe={arr:function(i){return Array.isArray(i)},obj:function(i){return tr(Object.prototype.toString.call(i),"Object")},pth:function(i){return pe.obj(i)&&i.hasOwnProperty("totalLength")},svg:function(i){return i instanceof SVGElement},inp:function(i){return i instanceof HTMLInputElement},dom:function(i){return i.nodeType||pe.svg(i)},str:function(i){return typeof i=="string"},fnc:function(i){return typeof i=="function"},und:function(i){return typeof i>"u"},nil:function(i){return pe.und(i)||i===null},hex:function(i){return/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(i)},rgb:function(i){return/^rgb/.test(i)},hsl:function(i){return/^hsl/.test(i)},col:function(i){return pe.hex(i)||pe.rgb(i)||pe.hsl(i)},key:function(i){return!Eh.hasOwnProperty(i)&&!za.hasOwnProperty(i)&&i!=="targets"&&i!=="keyframes"}};function Ah(i){var e=/\(([^)]+)\)/.exec(i);return e?e[1].split(",").map(function(t){return parseFloat(t)}):[]}function Ch(i,e){var t=Ah(i),n=Yt(pe.und(t[0])?1:t[0],.1,100),r=Yt(pe.und(t[1])?100:t[1],.1,100),s=Yt(pe.und(t[2])?10:t[2],.1,100),o=Yt(pe.und(t[3])?0:t[3],.1,100),a=Math.sqrt(r/n),l=s/(2*Math.sqrt(r*n)),c=l<1?a*Math.sqrt(1-l*l):0,u=1,h=l<1?(l*a+-o)/c:-o+a;function d(g){var _=e?e*g/1e3:g;return l<1?_=Math.exp(-_*l*a)*(u*Math.cos(c*_)+h*Math.sin(c*_)):_=(u+h*_)*Math.exp(-_*a),g===0||g===1?g:1-_}function f(){var g=xs.springs[i];if(g)return g;for(var _=1/6,v=0,m=0;;)if(v+=_,d(v)===1){if(m++,m>=16)break}else m=0;var p=v*_*1e3;return xs.springs[i]=p,p}return e?d:f}function ty(i){return i===void 0&&(i=10),function(e){return Math.ceil(Yt(e,1e-6,1)*i)*(1/i)}}var ny=function(){var i=11,e=1/(i-1);function t(u,h){return 1-3*h+3*u}function n(u,h){return 3*h-6*u}function r(u){return 3*u}function s(u,h,d){return((t(h,d)*u+n(h,d))*u+r(h))*u}function o(u,h,d){return 3*t(h,d)*u*u+2*n(h,d)*u+r(h)}function a(u,h,d,f,g){var _,v,m=0;do v=h+(d-h)/2,_=s(v,f,g)-u,_>0?d=v:h=v;while(Math.abs(_)>1e-7&&++m<10);return v}function l(u,h,d,f){for(var g=0;g<4;++g){var _=o(h,d,f);if(_===0)return h;var v=s(h,d,f)-u;h-=v/_}return h}function c(u,h,d,f){if(!(0<=u&&u<=1&&0<=d&&d<=1))return;var g=new Float32Array(i);if(u!==h||d!==f)for(var _=0;_<i;++_)g[_]=s(_*e,u,d);function v(m){for(var p=0,S=1,x=i-1;S!==x&&g[S]<=m;++S)p+=e;--S;var E=(m-g[S])/(g[S+1]-g[S]),L=p+E*e,P=o(L,u,d);return P>=.001?l(m,L,u,d):P===0?L:a(m,p,p+e,u,d)}return function(m){return u===h&&d===f||m===0||m===1?m:s(v(m),h,f)}}return c}(),Lh=function(){var i={linear:function(){return function(n){return n}}},e={Sine:function(){return function(n){return 1-Math.cos(n*Math.PI/2)}},Expo:function(){return function(n){return n?Math.pow(2,10*n-10):0}},Circ:function(){return function(n){return 1-Math.sqrt(1-n*n)}},Back:function(){return function(n){return n*n*(3*n-2)}},Bounce:function(){return function(n){for(var r,s=4;n<((r=Math.pow(2,--s))-1)/11;);return 1/Math.pow(4,3-s)-7.5625*Math.pow((r*3-2)/22-n,2)}},Elastic:function(n,r){n===void 0&&(n=1),r===void 0&&(r=.5);var s=Yt(n,1,10),o=Yt(r,.1,2);return function(a){return a===0||a===1?a:-s*Math.pow(2,10*(a-1))*Math.sin((a-1-o/(Math.PI*2)*Math.asin(1/s))*(Math.PI*2)/o)}}},t=["Quad","Cubic","Quart","Quint"];return t.forEach(function(n,r){e[n]=function(){return function(s){return Math.pow(s,r+2)}}}),Object.keys(e).forEach(function(n){var r=e[n];i["easeIn"+n]=r,i["easeOut"+n]=function(s,o){return function(a){return 1-r(s,o)(1-a)}},i["easeInOut"+n]=function(s,o){return function(a){return a<.5?r(s,o)(a*2)/2:1-r(s,o)(a*-2+2)/2}},i["easeOutIn"+n]=function(s,o){return function(a){return a<.5?(1-r(s,o)(1-a*2))/2:(r(s,o)(a*2-1)+1)/2}}}),i}();function Oa(i,e){if(pe.fnc(i))return i;var t=i.split("(")[0],n=Lh[t],r=Ah(i);switch(t){case"spring":return Ch(i,e);case"cubicBezier":return Ro(ny,r);case"steps":return Ro(ty,r);default:return Ro(n,r)}}function Rh(i){try{var e=document.querySelectorAll(i);return e}catch{return}}function Os(i,e){for(var t=i.length,n=arguments.length>=2?arguments[1]:void 0,r=[],s=0;s<t;s++)if(s in i){var o=i[s];e.call(n,o,s,i)&&r.push(o)}return r}function Us(i){return i.reduce(function(e,t){return e.concat(pe.arr(t)?Us(t):t)},[])}function Gc(i){return pe.arr(i)?i:(pe.str(i)&&(i=Rh(i)||i),i instanceof NodeList||i instanceof HTMLCollection?[].slice.call(i):[i])}function Ua(i,e){return i.some(function(t){return t===e})}function ka(i){var e={};for(var t in i)e[t]=i[t];return e}function ra(i,e){var t=ka(i);for(var n in i)t[n]=e.hasOwnProperty(n)?e[n]:i[n];return t}function ks(i,e){var t=ka(i);for(var n in e)t[n]=pe.und(i[n])?e[n]:i[n];return t}function iy(i){var e=/rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(i);return e?"rgba("+e[1]+",1)":i}function ry(i){var e=/^#?([a-f\d])([a-f\d])([a-f\d])$/i,t=i.replace(e,function(a,l,c,u){return l+l+c+c+u+u}),n=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t),r=parseInt(n[1],16),s=parseInt(n[2],16),o=parseInt(n[3],16);return"rgba("+r+","+s+","+o+",1)"}function sy(i){var e=/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(i)||/hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(i),t=parseInt(e[1],10)/360,n=parseInt(e[2],10)/100,r=parseInt(e[3],10)/100,s=e[4]||1;function o(d,f,g){return g<0&&(g+=1),g>1&&(g-=1),g<1/6?d+(f-d)*6*g:g<1/2?f:g<2/3?d+(f-d)*(2/3-g)*6:d}var a,l,c;if(n==0)a=l=c=r;else{var u=r<.5?r*(1+n):r+n-r*n,h=2*r-u;a=o(h,u,t+1/3),l=o(h,u,t),c=o(h,u,t-1/3)}return"rgba("+a*255+","+l*255+","+c*255+","+s+")"}function oy(i){if(pe.rgb(i))return iy(i);if(pe.hex(i))return ry(i);if(pe.hsl(i))return sy(i)}function un(i){var e=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(i);if(e)return e[1]}function ay(i){if(tr(i,"translate")||i==="perspective")return"px";if(tr(i,"rotate")||tr(i,"skew"))return"deg"}function sa(i,e){return pe.fnc(i)?i(e.target,e.id,e.total):i}function $t(i,e){return i.getAttribute(e)}function Ha(i,e,t){var n=un(e);if(Ua([t,"deg","rad","turn"],n))return e;var r=xs.CSS[e+t];if(!pe.und(r))return r;var s=100,o=document.createElement(i.tagName),a=i.parentNode&&i.parentNode!==document?i.parentNode:document.body;a.appendChild(o),o.style.position="absolute",o.style.width=s+t;var l=s/o.offsetWidth;a.removeChild(o);var c=l*parseFloat(e);return xs.CSS[e+t]=c,c}function Ph(i,e,t){if(e in i.style){var n=e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase(),r=i.style[e]||getComputedStyle(i).getPropertyValue(n)||"0";return t?Ha(i,r,t):r}}function Va(i,e){if(pe.dom(i)&&!pe.inp(i)&&(!pe.nil($t(i,e))||pe.svg(i)&&i[e]))return"attribute";if(pe.dom(i)&&Ua(ey,e))return"transform";if(pe.dom(i)&&e!=="transform"&&Ph(i,e))return"css";if(i[e]!=null)return"object"}function Dh(i){if(pe.dom(i)){for(var e=i.style.transform||"",t=/(\w+)\(([^)]*)\)/g,n=new Map,r;r=t.exec(e);)n.set(r[1],r[2]);return n}}function ly(i,e,t,n){var r=tr(e,"scale")?1:0+ay(e),s=Dh(i).get(e)||r;return t&&(t.transforms.list.set(e,s),t.transforms.last=e),n?Ha(i,s,n):s}function Ga(i,e,t,n){switch(Va(i,e)){case"transform":return ly(i,e,n,t);case"css":return Ph(i,e,t);case"attribute":return $t(i,e);default:return i[e]||0}}function Wa(i,e){var t=/^(\*=|\+=|-=)/.exec(i);if(!t)return i;var n=un(i)||0,r=parseFloat(e),s=parseFloat(i.replace(t[0],""));switch(t[0][0]){case"+":return r+s+n;case"-":return r-s+n;case"*":return r*s+n}}function Ih(i,e){if(pe.col(i))return oy(i);if(/\s/g.test(i))return i;var t=un(i),n=t?i.substr(0,i.length-t.length):i;return e?n+e:n}function qa(i,e){return Math.sqrt(Math.pow(e.x-i.x,2)+Math.pow(e.y-i.y,2))}function cy(i){return Math.PI*2*$t(i,"r")}function uy(i){return $t(i,"width")*2+$t(i,"height")*2}function hy(i){return qa({x:$t(i,"x1"),y:$t(i,"y1")},{x:$t(i,"x2"),y:$t(i,"y2")})}function Fh(i){for(var e=i.points,t=0,n,r=0;r<e.numberOfItems;r++){var s=e.getItem(r);r>0&&(t+=qa(n,s)),n=s}return t}function dy(i){var e=i.points;return Fh(i)+qa(e.getItem(e.numberOfItems-1),e.getItem(0))}function Nh(i){if(i.getTotalLength)return i.getTotalLength();switch(i.tagName.toLowerCase()){case"circle":return cy(i);case"rect":return uy(i);case"line":return hy(i);case"polyline":return Fh(i);case"polygon":return dy(i)}}function fy(i){var e=Nh(i);return i.setAttribute("stroke-dasharray",e),e}function py(i){for(var e=i.parentNode;pe.svg(e)&&pe.svg(e.parentNode);)e=e.parentNode;return e}function Bh(i,e){var t=e||{},n=t.el||py(i),r=n.getBoundingClientRect(),s=$t(n,"viewBox"),o=r.width,a=r.height,l=t.viewBox||(s?s.split(" "):[0,0,o,a]);return{el:n,viewBox:l,x:l[0]/1,y:l[1]/1,w:o,h:a,vW:l[2],vH:l[3]}}function my(i,e){var t=pe.str(i)?Rh(i)[0]:i,n=e||100;return function(r){return{property:r,el:t,svg:Bh(t),totalLength:Nh(t)*(n/100)}}}function gy(i,e,t){function n(u){u===void 0&&(u=0);var h=e+u>=1?e+u:0;return i.el.getPointAtLength(h)}var r=Bh(i.el,i.svg),s=n(),o=n(-1),a=n(1),l=t?1:r.w/r.vW,c=t?1:r.h/r.vH;switch(i.property){case"x":return(s.x-r.x)*l;case"y":return(s.y-r.y)*c;case"angle":return Math.atan2(a.y-o.y,a.x-o.x)*180/Math.PI}}function Wc(i,e){var t=/[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,n=Ih(pe.pth(i)?i.totalLength:i,e)+"";return{original:n,numbers:n.match(t)?n.match(t).map(Number):[0],strings:pe.str(i)||e?n.split(t):[]}}function Xa(i){var e=i?Us(pe.arr(i)?i.map(Gc):Gc(i)):[];return Os(e,function(t,n,r){return r.indexOf(t)===n})}function zh(i){var e=Xa(i);return e.map(function(t,n){return{target:t,id:n,total:e.length,transforms:{list:Dh(t)}}})}function _y(i,e){var t=ka(e);if(/^spring/.test(t.easing)&&(t.duration=Ch(t.easing)),pe.arr(i)){var n=i.length,r=n===2&&!pe.obj(i[0]);r?i={value:i}:pe.fnc(e.duration)||(t.duration=e.duration/n)}var s=pe.arr(i)?i:[i];return s.map(function(o,a){var l=pe.obj(o)&&!pe.pth(o)?o:{value:o};return pe.und(l.delay)&&(l.delay=a?0:e.delay),pe.und(l.endDelay)&&(l.endDelay=a===s.length-1?e.endDelay:0),l}).map(function(o){return ks(o,t)})}function vy(i){for(var e=Os(Us(i.map(function(s){return Object.keys(s)})),function(s){return pe.key(s)}).reduce(function(s,o){return s.indexOf(o)<0&&s.push(o),s},[]),t={},n=function(s){var o=e[s];t[o]=i.map(function(a){var l={};for(var c in a)pe.key(c)?c==o&&(l.value=a[c]):l[c]=a[c];return l})},r=0;r<e.length;r++)n(r);return t}function xy(i,e){var t=[],n=e.keyframes;n&&(e=ks(vy(n),e));for(var r in e)pe.key(r)&&t.push({name:r,tweens:_y(e[r],i)});return t}function yy(i,e){var t={};for(var n in i){var r=sa(i[n],e);pe.arr(r)&&(r=r.map(function(s){return sa(s,e)}),r.length===1&&(r=r[0])),t[n]=r}return t.duration=parseFloat(t.duration),t.delay=parseFloat(t.delay),t}function My(i,e){var t;return i.tweens.map(function(n){var r=yy(n,e),s=r.value,o=pe.arr(s)?s[1]:s,a=un(o),l=Ga(e.target,i.name,a,e),c=t?t.to.original:l,u=pe.arr(s)?s[0]:c,h=un(u)||un(l),d=a||h;return pe.und(o)&&(o=c),r.from=Wc(u,d),r.to=Wc(Wa(o,u),d),r.start=t?t.end:0,r.end=r.start+r.delay+r.duration+r.endDelay,r.easing=Oa(r.easing,r.duration),r.isPath=pe.pth(s),r.isPathTargetInsideSVG=r.isPath&&pe.svg(e.target),r.isColor=pe.col(r.from.original),r.isColor&&(r.round=1),t=r,r})}var Oh={css:function(i,e,t){return i.style[e]=t},attribute:function(i,e,t){return i.setAttribute(e,t)},object:function(i,e,t){return i[e]=t},transform:function(i,e,t,n,r){if(n.list.set(e,t),e===n.last||r){var s="";n.list.forEach(function(o,a){s+=a+"("+o+") "}),i.style.transform=s}}};function Uh(i,e){var t=zh(i);t.forEach(function(n){for(var r in e){var s=sa(e[r],n),o=n.target,a=un(s),l=Ga(o,r,a,n),c=a||un(l),u=Wa(Ih(s,c),l),h=Va(o,r);Oh[h](o,r,u,n.transforms,!0)}})}function by(i,e){var t=Va(i.target,e.name);if(t){var n=My(e,i),r=n[n.length-1];return{type:t,property:e.name,animatable:i,tweens:n,duration:r.end,delay:n[0].delay,endDelay:r.endDelay}}}function wy(i,e){return Os(Us(i.map(function(t){return e.map(function(n){return by(t,n)})})),function(t){return!pe.und(t)})}function kh(i,e){var t=i.length,n=function(s){return s.timelineOffset?s.timelineOffset:0},r={};return r.duration=t?Math.max.apply(Math,i.map(function(s){return n(s)+s.duration})):e.duration,r.delay=t?Math.min.apply(Math,i.map(function(s){return n(s)+s.delay})):e.delay,r.endDelay=t?r.duration-Math.max.apply(Math,i.map(function(s){return n(s)+s.duration-s.endDelay})):e.endDelay,r}var qc=0;function Sy(i){var e=ra(Eh,i),t=ra(za,i),n=xy(t,i),r=zh(i.targets),s=wy(r,n),o=kh(s,t),a=qc;return qc++,ks(e,{id:a,children:[],animatables:r,animations:s,duration:o.duration,delay:o.delay,endDelay:o.endDelay})}var zt=[],Hh=function(){var i;function e(){!i&&(!Xc()||!Qe.suspendWhenDocumentHidden)&&zt.length>0&&(i=requestAnimationFrame(t))}function t(r){for(var s=zt.length,o=0;o<s;){var a=zt[o];a.paused?(zt.splice(o,1),s--):(a.tick(r),o++)}i=o>0?requestAnimationFrame(t):void 0}function n(){Qe.suspendWhenDocumentHidden&&(Xc()?i=cancelAnimationFrame(i):(zt.forEach(function(r){return r._onDocumentVisibility()}),Hh()))}return typeof document<"u"&&document.addEventListener("visibilitychange",n),e}();function Xc(){return!!document&&document.hidden}function Qe(i){i===void 0&&(i={});var e=0,t=0,n=0,r,s=0,o=null;function a(p){var S=window.Promise&&new Promise(function(x){return o=x});return p.finished=S,S}var l=Sy(i);a(l);function c(){var p=l.direction;p!=="alternate"&&(l.direction=p!=="normal"?"normal":"reverse"),l.reversed=!l.reversed,r.forEach(function(S){return S.reversed=l.reversed})}function u(p){return l.reversed?l.duration-p:p}function h(){e=0,t=u(l.currentTime)*(1/Qe.speed)}function d(p,S){S&&S.seek(p-S.timelineOffset)}function f(p){if(l.reversePlayback)for(var x=s;x--;)d(p,r[x]);else for(var S=0;S<s;S++)d(p,r[S])}function g(p){for(var S=0,x=l.animations,E=x.length;S<E;){var L=x[S],P=L.animatable,G=L.tweens,Q=G.length-1,U=G[Q];Q&&(U=Os(G,function(X){return p<X.end})[0]||U);for(var R=Yt(p-U.start-U.delay,0,U.duration)/U.duration,w=isNaN(R)?1:U.easing(R),b=U.to.strings,I=U.round,z=[],D=U.to.numbers.length,N=void 0,K=0;K<D;K++){var se=void 0,H=U.to.numbers[K],V=U.from.numbers[K]||0;U.isPath?se=gy(U.value,w*H,U.isPathTargetInsideSVG):se=V+w*(H-V),I&&(U.isColor&&K>2||(se=Math.round(se*I)/I)),z.push(se)}var ce=b.length;if(!ce)N=z[0];else{N=b[0];for(var ie=0;ie<ce;ie++){b[ie];var ue=b[ie+1],Le=z[ie];isNaN(Le)||(ue?N+=Le+ue:N+=Le+" ")}}Oh[L.type](P.target,L.property,N,P.transforms),L.currentValue=N,S++}}function _(p){l[p]&&!l.passThrough&&l[p](l)}function v(){l.remaining&&l.remaining!==!0&&l.remaining--}function m(p){var S=l.duration,x=l.delay,E=S-l.endDelay,L=u(p);l.progress=Yt(L/S*100,0,100),l.reversePlayback=L<l.currentTime,r&&f(L),!l.began&&l.currentTime>0&&(l.began=!0,_("begin")),!l.loopBegan&&l.currentTime>0&&(l.loopBegan=!0,_("loopBegin")),L<=x&&l.currentTime!==0&&g(0),(L>=E&&l.currentTime!==S||!S)&&g(S),L>x&&L<E?(l.changeBegan||(l.changeBegan=!0,l.changeCompleted=!1,_("changeBegin")),_("change"),g(L)):l.changeBegan&&(l.changeCompleted=!0,l.changeBegan=!1,_("changeComplete")),l.currentTime=Yt(L,0,S),l.began&&_("update"),p>=S&&(t=0,v(),l.remaining?(e=n,_("loopComplete"),l.loopBegan=!1,l.direction==="alternate"&&c()):(l.paused=!0,l.completed||(l.completed=!0,_("loopComplete"),_("complete"),!l.passThrough&&"Promise"in window&&(o(),a(l)))))}return l.reset=function(){var p=l.direction;l.passThrough=!1,l.currentTime=0,l.progress=0,l.paused=!0,l.began=!1,l.loopBegan=!1,l.changeBegan=!1,l.completed=!1,l.changeCompleted=!1,l.reversePlayback=!1,l.reversed=p==="reverse",l.remaining=l.loop,r=l.children,s=r.length;for(var S=s;S--;)l.children[S].reset();(l.reversed&&l.loop!==!0||p==="alternate"&&l.loop===1)&&l.remaining++,g(l.reversed?l.duration:0)},l._onDocumentVisibility=h,l.set=function(p,S){return Uh(p,S),l},l.tick=function(p){n=p,e||(e=n),m((n+(t-e))*Qe.speed)},l.seek=function(p){m(u(p))},l.pause=function(){l.paused=!0,h()},l.play=function(){l.paused&&(l.completed&&l.reset(),l.paused=!1,zt.push(l),h(),Hh())},l.reverse=function(){c(),l.completed=!l.reversed,h()},l.restart=function(){l.reset(),l.play()},l.remove=function(p){var S=Xa(p);Vh(S,l)},l.reset(),l.autoplay&&l.play(),l}function jc(i,e){for(var t=e.length;t--;)Ua(i,e[t].animatable.target)&&e.splice(t,1)}function Vh(i,e){var t=e.animations,n=e.children;jc(i,t);for(var r=n.length;r--;){var s=n[r],o=s.animations;jc(i,o),!o.length&&!s.children.length&&n.splice(r,1)}!t.length&&!n.length&&e.pause()}function Ty(i){for(var e=Xa(i),t=zt.length;t--;){var n=zt[t];Vh(e,n)}}function Ey(i,e){e===void 0&&(e={});var t=e.direction||"normal",n=e.easing?Oa(e.easing):null,r=e.grid,s=e.axis,o=e.from||0,a=o==="first",l=o==="center",c=o==="last",u=pe.arr(i),h=parseFloat(u?i[0]:i),d=u?parseFloat(i[1]):0,f=un(u?i[1]:i)||0,g=e.start||0+(u?h:0),_=[],v=0;return function(m,p,S){if(a&&(o=0),l&&(o=(S-1)/2),c&&(o=S-1),!_.length){for(var x=0;x<S;x++){if(!r)_.push(Math.abs(o-x));else{var E=l?(r[0]-1)/2:o%r[0],L=l?(r[1]-1)/2:Math.floor(o/r[0]),P=x%r[0],G=Math.floor(x/r[0]),Q=E-P,U=L-G,R=Math.sqrt(Q*Q+U*U);s==="x"&&(R=-Q),s==="y"&&(R=-U),_.push(R)}v=Math.max.apply(Math,_)}n&&(_=_.map(function(b){return n(b/v)*v})),t==="reverse"&&(_=_.map(function(b){return s?b<0?b*-1:-b:Math.abs(v-b)}))}var w=u?(d-h)/v:h;return g+w*(Math.round(_[p]*100)/100)+f}}function Ay(i){i===void 0&&(i={});var e=Qe(i);return e.duration=0,e.add=function(t,n){var r=zt.indexOf(e),s=e.children;r>-1&&zt.splice(r,1);function o(d){d.passThrough=!0}for(var a=0;a<s.length;a++)o(s[a]);var l=ks(t,ra(za,i));l.targets=l.targets||i.targets;var c=e.duration;l.autoplay=!1,l.direction=e.direction,l.timelineOffset=pe.und(n)?c:Wa(n,c),o(e),e.seek(l.timelineOffset);var u=Qe(l);o(u),s.push(u);var h=kh(s,i);return e.delay=h.delay,e.endDelay=h.endDelay,e.duration=h.duration,e.seek(0),e.reset(),e.autoplay&&e.play(),e},e}Qe.version="3.2.1";Qe.speed=1;Qe.suspendWhenDocumentHidden=!0;Qe.running=zt;Qe.remove=Ty;Qe.get=Ga;Qe.set=Uh;Qe.convertPx=Ha;Qe.path=my;Qe.setDashoffset=fy;Qe.stagger=Ey;Qe.timeline=Ay;Qe.easing=Oa;Qe.penner=Lh;Qe.random=function(i,e){return Math.floor(Math.random()*(e-i+1))+i};const Cy=(i,e,t,n,r,s,o)=>async(a,l)=>{const c=r/100;if(l){i.reticleStuff.hitTestSourceInitialized||(i=await K0(i));const{stats:u,scene:h,camera:d,renderer:f,reticleStuff:g,cubes:_}=i;if(g.active){if(g.hitTestSourceInitialized){const v=l.getHitTestResults(g.hitTestSource);if(v.length>0){const p=v[0].getPose(g.localSpace);g.reticle.visible=!0,g.reticle.matrix.fromArray(p.transform.matrix)}else g.reticle.visible=!1}}else g.reticle.visible=!1;_.pixelGrid!==void 0&&_.active===!0&&Q0(_,e,c,Qe),i.stats.update(),f.render(h,d)}},Ly=(i,e,t,n,r,s,o)=>{const{stats:a,scene:l,camera:c,renderer:u,reticleStuff:h,cubes:d}=i;return i.renderer.setAnimationLoop(Cy(i,e,t,n,r)),{stats:a,scene:l,camera:c,renderer:u,reticleStuff:h,cubes:d}},Ry=({stats:i,scene:e,camera:t,renderer:n})=>{const r={};r.active=!0;const s=new Pa(.15,.2,32).rotateX(-Math.PI/2),o=new _r;return r.reticle=new mt(s,o),r.reticle.matrixAutoUpdate=!1,r.reticle.visible=!1,e.add(r.reticle),r},Py=(i,e,t,n,r,s)=>{const o={pixelGridGroup:{},pixelGrid:[],moving:!1,active:!1,currentIndex:0},a=Th(),l=document.createElement("div");l.id="ar-container";const c=document.getElementById("bubble-sort");c==null||c.appendChild(l);const u=new Sa,h=new vt(75,window.innerWidth/window.innerHeight,.01,50);h.position.z=1,h.position.y=Math.abs(Math.floor(e/2))*r,h.position.x=Math.abs(Math.floor(i/2))*n;const d=new ph(16777215,12303359,1);d.position.set(.5,1,.25),u.add(d);const f=new He({antialias:!0,alpha:!0});f.setPixelRatio(window.devicePixelRatio),f.setSize(window.innerWidth,window.innerHeight),f.xr.enabled=!0,l.appendChild(f.domElement);const g=Ry({stats:a,scene:u,camera:h,renderer:f}),_=f.xr.getController(0);_.addEventListener("select",J0(g,o,i,e,n,r,s,u,h)),u.add(_),l.appendChild(a.dom);const v=document.getElementById("dom-overlay"),m=W0.createButton(`/?speed=${t}&scalex=${n}&scaley=${r}&scalez=${s}&cols=${i}&rows=${e}`,f,{requiredFeatures:["hit-test"],optionalFeatures:["dom-overlay"],domOverlay:{root:v}});v==null||v.appendChild(m),Ly({stats:a,scene:u,camera:h,renderer:f,reticleStuff:g,cubes:o},t,n,r,s),window.addEventListener("resize",q0(h,f,window))};Mh(yh("bubblesort"));const[Dy]=Sh({bubbleSort:{width:"100%",height:"100%",backgroundImage:"url(/img/bg1.png)",backgroundClip:"border-box",backgroundSize:"cover",backgroundRepeat:"none",position:"absolute"}}),Iy=i=>{const e=Math.abs(parseInt(i.cols)||5),t=Math.abs(parseInt(i.rows)||4),n=Math.abs(parseFloat(i.speed)||1),r=Math.abs(Math.floor(parseFloat(i.scalex))||10),s=Math.abs(Math.floor(parseFloat(i.scaley))||10),o=Math.abs(Math.floor(parseFloat(i.scalez))||10),[a,l]=gu(V0,{cols:e,rows:t,speed:n,scaleX:r,scaleY:s,scaleZ:o});return _u(()=>{Th(),Py(a.cols,a.rows,a.speed,a.scaleX,a.scaleY,a.scaleZ)}),pr`
    <div id="bubble-sort" className="${Dy.bubbleSort}">
      <div id="dom-overlay">
  ...
  `,Yc=document.getElementById("goodthing");Yc&&Kh(pr`<${Fy} />`,Yc);
