...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function mc(){const i=new $(1,1);return new Os({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null},texelSize:{value:i},inputEncoding:{value:Ms[kt]}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function gc(){return new Os({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},inputEncoding:{value:Ms[kt]}},vertexShader:Ia(),fragmentShader:`
...
`)}function gh(i){switch(i){case kt:return["Linear","( value )"];case Li:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported encoding:",i),["Linear","( value )"]}}function Tc(i,e,t){const n=i.getShaderParameter(e,35713),r=i.getShaderInfoLog(e).trim();return n&&r===""?"":t.toUpperCase()+`
...
void main() {
  ...
  `,du=document.getElementById("goodthing");du&&wf(xr`<${RM} />`,du);
