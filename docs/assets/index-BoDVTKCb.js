...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function Jl(){const i=new $(1,1);return new Is({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null},texelSize:{value:i},inputEncoding:{value:ms[Ot]}},vertexShader:ya(),fragmentShader:`
...
`].filter(Yi).join(`
`)),o=Zo(o),o=lc(o,t),o=cc(o,t),a=Zo(a),a=lc(a,t),a=cc(a,t),o=uc(o),a=uc(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(m=`#version 300 es
...
void main() {
  ...
  `,jc=document.getElementById("goodthing");jc&&Kh(pr`<${Fy} />`,jc);
