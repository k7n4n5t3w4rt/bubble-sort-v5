...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function mc(){const i=new $(1,1);return new Os({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null},texelSize:{value:i},inputEncoding:{value:Ms[Ut]}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function gc(){return new Os({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},inputEncoding:{value:Ms[Ut]}},vertexShader:Ia(),fragmentShader:`
